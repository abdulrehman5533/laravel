...
@section('title', 'Add New Employee | ' . config('app.name'))
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom">
        <div>
            <h1 class="h4 fw-bold mb-1"><i class="fas fa-user-plus me-2 text-primary"></i>Employee Registration</h1>
    ...
    <form action="{{ route('hr.employees.store') }}" method="POST" id="employeeForm">
        ...
        <div class="row g-4">
            ...
            <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="employee_code" class="form-control form-control-sm @error('employee_code') is-invalid @enderror"
                                    value="{{ old('employee_code') }}" placeholder="EMP001" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="date_of_birth" class="form-control form-control-sm" value="{{ old('date_of_birth') }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-bold">CNIC / National ID</label>
                                <input type="text" name="national_id" class="form-control form-control-sm"
                                    value="{{ old('national_id') }}" placeholder="xxxxx-xxxxxxx-x">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-bold">Tax ID (NTN)</label>
                                <input type="text" name="tax_id" class="form-control form-control-sm" value="{{ old('tax_id') }}">
                            </div>
                            <div class="col-12">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="department" class="form-control form-control-sm"
                                    value="{{ old('department') }}" placeholder="e.g. Sales, Production" required>
                            </div>
                            <div class="col-md-4">
                                ...
                                <select name="designation" class="form-select form-select-sm" required>
                                    ...
                                    <option value="Sales Consultant" {{ old('designation') == 'Sales Consultant' ? 'selected' : '' }}>Sales Consultant</option>
                                    <option value="Goldsmith"        {{ old('designation') == 'Goldsmith'        ? 'selected' : '' }}>Goldsmith (Karigar)</option>
                                    <option value="Appraiser"        {{ old('designation') == 'Appraiser'        ? 'selected' : '' }}>Appraiser</option>
                                    <option value="Accountant"       {{ old('designation') == 'Accountant'       ? 'selected' : '' }}>Accountant</option>
                                    <option value="Security"         {{ old('designation') == 'Security'         ? 'selected' : '' }}>Security</option>
                                    <option value="Cashier"          {{ old('designation') == 'Cashier'          ? 'selected' : '' }}>Cashier</option>
                                    <option value="HR Officer"       {{ old('designation') == 'HR Officer'       ? 'selected' : '' }}>HR Officer</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <small class="text-muted" style="font-size:0.65rem;">Required for attendance tracking via app.</small>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="probation_end_date" class="form-control form-control-sm"
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="country_code" class="form-select form-select-sm" required>
                                    <option value="PK" {{ old('country_code', 'PK') == 'PK' ? 'selected' : '' }}>Pakistan</option>
                                    <option value="AE" {{ old('country_code') == 'AE' ? 'selected' : '' }}>UAE</option>
                                    ...
                                    <option value="GB" {{ old('country_code') == 'GB' ? 'selected' : '' }}>UK</option>
                                    <option value="US" {{ old('country_code') == 'US' ? 'selected' : '' }}>USA</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-bold">Biometric ID</label>
                                <input type="text" name="biometric_id" class="form-control form-control-sm"
                                    value="{{ old('biometric_id') }}" placeholder="For fingerprint device">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-bold">Attendance PIN</label>
                                <input type="text" name="attendance_pin" class="form-control form-control-sm"
                                    value="{{ old('attendance_pin') }}" placeholder="4-digit PIN" maxlength="6">
                            </div>
                            <div class="col-md-4">
                                <div class="form-check mt-4 pt-1">
                                    <input class="form-check-input" type="checkbox" name="is_karigar" value="1"
                                        id="is_karigar" {{ old('is_karigar') ? 'checked' : '' }}>
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label small fw-bold">Basic / Base Salary (PKR) <span class="text-danger">*</span></label>
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" step="0.01" name="base_salary" id="base_salary"
                                        ...
                                        value="{{ old('base_salary') }}" placeholder="0.00" required oninput="calcNet()">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" step="0.01" name="medical_allowance" id="medical_allowance"
                                        class="form-control" value="{{ old('medical_allowance', 0) }}" oninput="calcNet()">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" step="0.01" name="transport_allowance" id="transport_allowance"
                                        class="form-control" value="{{ old('transport_allowance', 0) }}" oninput="calcNet()">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" step="0.01" name="eobi_deduction" id="eobi_deduction"
                                        class="form-control" value="{{ old('eobi_deduction', 0) }}" oninput="calcNet()">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" step="0.01" name="pessi_deduction" id="pessi_deduction"
                                        class="form-control" value="{{ old('pessi_deduction', 0) }}" oninput="calcNet()">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" step="0.01" name="income_tax" id="income_tax"
                                        class="form-control" value="{{ old('income_tax', 0) }}" oninput="calcNet()">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="number" step="0.01" name="commission_percentage"
                                        class="form-control" value="{{ old('commission_percentage', 0) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="performance_score" class="form-control form-control-sm"
                                    value="{{ old('performance_score', 0) }}" min="0" max="100">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="bank_details[bank_name]" class="form-control form-control-sm"
                                    value="{{ old('bank_details.bank_name') }}" placeholder="e.g. HBL, MCB, UBL">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="bank_details[account_name]" class="form-control form-control-sm"
                                    value="{{ old('bank_details.account_name') }}">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="bank_details[account_number]" class="form-control form-control-sm"
                                    value="{{ old('bank_details.account_number') }}">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="bank_details[ifsc_code]" class="form-control form-control-sm"
                                    value="{{ old('bank_details.ifsc_code') }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-4">
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h6 class="mb-0 fw-bold text-primary"><i class="fas fa-cog me-2"></i>Status & Actions</h6>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            ...
                            <input type="text" name="emergency_contact[name]" class="form-control form-control-sm"
                                value="{{ old('emergency_contact.name') }}">
                        </div>
                        <div class="mb-2">
                            <label class="form-label small fw-bold">Relationship</label>
                            <select name="emergency_contact[relationship]" class="form-select form-select-sm">
                                <option value="">-- Select --</option>
                        ...
                        <div class="mb-2">
                            <label class="form-label small fw-bold">Phone Number</label>
                            <input type="text" name="emergency_contact[phone]" class="form-control form-control-sm"
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <textarea name="skills" class="form-control form-control-sm" rows="3"
                            placeholder="Gold Casting, Diamond Grading, Sales...">{{ is_array(old('skills')) ? implode(', ', old('skills')) : old('skills') }}</textarea>
                        <small class="text-muted" style="font-size:0.65rem;">Separate multiple skills with commas</small>
                    </div>
                </div>

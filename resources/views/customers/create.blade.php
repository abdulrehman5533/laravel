...
@section('title', 'Add New Customer - CRM')
...
<div class="container-fluid py-4">
    ...
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            <h1 class="h3 mb-1 text-dark fw-bold">Add New Customer</h1>
            <p class="text-muted small mb-0">Create a new customer profile in the system</p>
        </div>
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <a href="{{ route('customers.index') }}" class="btn btn-light shadow-sm border px-4">
    ...
    <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="first_name" class="form-control rounded-8 @error('first_name') is-invalid @enderror" value="{{ old('first_name') }}" placeholder="Enter first name" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="last_name" class="form-control rounded-8 @error('last_name') is-invalid @enderror" value="{{ old('last_name') }}" placeholder="Enter last name" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control border-start-0 rounded-end-8 @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="customer@example.com">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone" class="form-control border-start-0 rounded-end-8 @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="+92 XXX XXXXXXX">
                                </div>
                                @error('phone') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small text-uppercase text-muted">Alternative Mobile</label>
                                <input type="text" name="mobile" class="form-control rounded-8 @error('mobile') is-invalid @enderror" value="{{ old('mobile') }}" placeholder="Enter alternative number">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="date_of_birth" class="form-control rounded-8" value="{{ old('date_of_birth') }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="address_line_1" class="form-control rounded-8" value="{{ old('address_line_1') }}" placeholder="House #, Street name...">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold small text-uppercase text-muted">Address Line 2</label>
                                <input type="text" name="address_line_2" class="form-control rounded-8" value="{{ old('address_line_2') }}" placeholder="Apartment, suite, unit, etc. (optional)">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small text-uppercase text-muted">City</label>
                                <input type="text" name="city" class="form-control rounded-8" value="{{ old('city') }}" placeholder="Enter city">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small text-uppercase text-muted">State / Province</label>
                                <input type="text" name="state" class="form-control rounded-8" value="{{ old('state') }}" placeholder="Enter state">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small text-uppercase text-muted">Postal Code</label>
                                <input type="text" name="postal_code" class="form-control rounded-8" value="{{ old('postal_code') }}" placeholder="Enter zip code">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small text-uppercase text-muted">Country</label>
                                <input type="text" name="country" class="form-control rounded-8" value="{{ old('country', 'Pakistan') }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="position-relative" style="z-index: 1;">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="customer_type" id="customer_type" class="form-select border-0 rounded-8 fw-bold">
                                    <option value="individual" {{ old('customer_type') == 'individual' ? 'selected' : '' }}>Individual Customer</option>
                                    <option value="business" {{ old('customer_type') == 'business' ? 'selected' : '' }}>Business Entity</option>
                                </select>
                            </div>

                            <div id="business_fields" class="{{ old('customer_type') == 'business' ? '' : 'd-none' }}">
                                <div class="bg-white bg-opacity-10 rounded-8 p-3 mb-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="company_name" class="form-control border-0 rounded-8" value="{{ old('company_name') }}" placeholder="Enter business name">
                                    </div>
                                    <div class="mb-0">
                                        <label class="form-label small text-uppercase text-white-50">Tax ID / NTN</label>
                                        <input type="text" name="tax_id" class="form-control border-0 rounded-8" value="{{ old('tax_id') }}" placeholder="Enter NTN number">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-0">
                                ...
                                <select name="membership_level" class="form-select border-0 rounded-8 fw-bold">
                                    <option value="bronze" {{ old('membership_level') == 'bronze' ? 'selected' : '' }}>Bronze Tier</option>
                                    <option value="silver" {{ old('membership_level') == 'silver' ? 'selected' : '' }}>Silver Tier</option>
                                    <option value="gold" {{ old('membership_level') == 'gold' ? 'selected' : '' }}>Gold Tier</option>
                                    <option value="platinum" {{ old('membership_level') == 'platinum' ? 'selected' : '' }}>Platinum Tier</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" name="credit_limit" class="form-control border-start-0 rounded-end-8 fw-bold" value="{{ old('credit_limit', 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.1" name="special_discount_percentage" class="form-control rounded-start-8 fw-bold text-primary" value="{{ old('special_discount_percentage', 0) }}">
                ...
                <div class="card border-0 shadow-sm rounded-12">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" class="form-control rounded-8" rows="3" placeholder="Additional customer details...">{{ old('notes') }}</textarea>
                        </div>
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="marketing_consent" id="marketing_consent" value="1" {{ old('marketing_consent', true) ? 'checked' : '' }}>
        ...
        <div class="row mt-4 mb-5">
            <div class="col-12 text-center">
                ...
                <button type="reset" class="btn btn-outline-secondary px-5 py-2 rounded-8 me-3 fw-bold">Reset Form</button>
                <button type="submit" class="btn btn-primary px-5 py-2 rounded-8 fw-bold shadow">
                    <i class="fas fa-save me-2"></i>Save Customer Profile
                </button>
            </div>
        </div>
    </form>
...
<script>
    document.getElementById('customer_type').addEventListener('change', function() {
        ...
        if (this.value === 'business') {
            ...
            businessFields.classList.add('animate__animated', 'animate__fadeIn');
        } else {

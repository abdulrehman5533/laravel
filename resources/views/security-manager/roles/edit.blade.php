...
<div class="container-fluid py-4">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6">
            <h1 class="h2 mb-1 text-dark fw-800">Refine Architecture</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active fw-600" aria-current="page">{{ $role->name }}</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card border-0 shadow-premium rounded-20 overflow-hidden">
                <div class="card-header bg-white border-0 p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fw-800 text-dark">Role Refinement</h5>
                    </div>
                </div>
                <div class="card-body p-4 pt-0">
                    <form method="POST" action="{{ route('security-manager.roles.update', $role) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-12">
                                ...
                                <div class="input-group premium-input-group">
                                    ...
                                    <input type="text" name="name" class="form-control border-0 bg-light rounded-end-12 py-3 @error('name') is-invalid @enderror" value="{{ old('name', $role->name) }}" required>
                                    @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control border-0 bg-light rounded-12 py-3" rows="3">{{ old('description', $role->description) }}</textarea>
                        </div>
                        ...
                        <div class="row g-4 mb-5">
                            <div class="col-md-6">
                                ...
                                <div class="input-group premium-input-group">
                                    ...
                                    <input type="number" name="session_timeout_minutes" class="form-control border-0 bg-light rounded-end-12 py-3" value="{{ old('session_timeout_minutes', $role->session_timeout_minutes) }}" min="5" max="1440" required>
                                </div>
                            ...
                            <div class="col-md-6 d-flex align-items-center">
                                <div class="p-3 bg-light rounded-15 border w-100">
                                    ...
                                    <div class="text-muted smaller fw-600 ms-5">Active roles can be assigned to subjects</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body p-4 position-relative">
                    ...
                    <div class="p-4 bg-white-10 rounded-20 mt-5">
                        <div class="d-flex align-items-center text-gold mb-3">
                            ...
                            <span class="fw-800 small">Capabilities Matrix</span>
                        </div>
                        <p class="text-white-50 smaller fw-600 mb-0">Changes to role names or TTLs do not impact the underlying permission bindings.</p>
                    </div>
                </div>
            </div>
        </div>

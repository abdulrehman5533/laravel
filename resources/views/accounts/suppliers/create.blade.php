    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-dark fw-bold">
                <i class="fas fa-user-plus text-primary me-2"></i>New Supplier
            </h1>
            <p class="text-muted mt-1">Register a new supplier for your business</p>
        </div>
    </div>
        ...
        <div class="col-lg-10">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('accounts.suppliers.store') }}">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="supplier_type" class="form-select @error('supplier_type') is-invalid @enderror" required>
                                        ...
                                        <option value="Gold" {{ old('supplier_type') == 'Gold' ? 'selected' : '' }}>Gold</option>
                                        <option value="Silver" {{ old('supplier_type') == 'Silver' ? 'selected' : '' }}>Silver</option>
                                        <option value="Diamond" {{ old('supplier_type') == 'Diamond' ? 'selected' : '' }}>Diamond</option>
                                        <option value="Gems" {{ old('supplier_type') == 'Gems' ? 'selected' : '' }}>Gems</option>
                                        <option value="Jewelry" {{ old('supplier_type') == 'Jewelry' ? 'selected' : '' }}>Jewelry</option>
                                        <option value="Machinery" {{ old('supplier_type') == 'Machinery' ? 'selected' : '' }}>Machinery</option>
                                        <option value="Packaging" {{ old('supplier_type') == 'Packaging' ? 'selected' : '' }}>Packaging</option>
                                        <option value="Services" {{ old('supplier_type', request('type')) == 'Services' ? 'selected' : '' }}>Services</option>
                                        <option value="Karigar" {{ old('supplier_type', request('type')) == 'Karigar' ? 'selected' : '' }}>Karigar</option>
                                        <option value="Other" {{ old('supplier_type', request('type')) == 'Other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                    @error('supplier_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="gstin" class="form-control @error('gstin') is-invalid @enderror"
                                           value="{{ old('gstin') }}" placeholder="STRN Number">
                                    @error('gstin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="pan" class="form-control @error('pan') is-invalid @enderror"
                                           value="{{ old('pan') }}" placeholder="NTN Number">
                                    @error('pan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="payment_terms" class="form-control @error('payment_terms') is-invalid @enderror"
                                           value="{{ old('payment_terms') }}" placeholder="e.g., Net 30, 2/10 Net 30">
                                    @error('payment_terms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="payment_days" class="form-control @error('payment_days') is-invalid @enderror"
                                           value="{{ old('payment_days', 30) }}" min="0">
                                    @error('payment_days')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="product_specialty" class="form-control @error('product_specialty') is-invalid @enderror"
                                           value="{{ old('product_specialty') }}" placeholder="e.g., Gold Jewelry, Diamond Stones">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" 
                                      rows="3" placeholder="Any additional notes about this supplier">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('accounts.suppliers.index') }}" class="btn btn-secondary">

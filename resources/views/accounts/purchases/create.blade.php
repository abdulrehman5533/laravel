...
<div class="container-fluid py-4">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6">
            <h1 class="h2 mb-1 text-dark fw-800">Procurement Issuance</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active fw-600" aria-current="page">New Issuance</li>
                </ol>
            </nav>
        </div>
    ...
    <form method="POST" action="{{ route('accounts.purchases.orders.store') }}">
        @csrf
        <div class="row g-4">
            <!-- Form Body -->
            <div class="col-lg-8">
                <div class="card border-0 shadow-premium rounded-24 overflow-hidden mb-4">
                    <div class="card-header bg-premium-dark p-4 border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-white fw-800">Procurement Protocol</h5>
                        </div>
                    </div>
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row g-4 mb-5">
                            <div class="col-md-4">
                                <label class="form-label fw-700 small text-uppercase tracking-wider text-muted mb-2">Invoice Protocol <span class="text-danger">*</span></label>
                                <div class="glass-input-group">
                                    <span class="input-group-text bg-transparent border-0"><i class="fas fa-file-invoice text-primary"></i></span>
                                    <select name="invoice_type" class="form-select bg-transparent border-0 @error('invoice_type') is-invalid @enderror" required>
                                        <option value="Retail" {{ old('invoice_type') == 'Retail' ? 'selected' : '' }}>Retail Invoice</option>
                                        <option value="Tax" {{ old('invoice_type') == 'Tax' ? 'selected' : '' }}>Tax Invoice</option>
                                        <option value="URD" {{ old('invoice_type') == 'URD' ? 'selected' : '' }}>URD Purchase</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="glass-input-group">
                                    ...
                                    <select name="material_type" class="form-select bg-transparent border-0 @error('material_type') is-invalid @enderror" required>
                                        ...
                                        <option value="Gems" {{ old('material_type') == 'Gems' ? 'selected' : '' }}>Gems</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="glass-input-group">
                                    ...
                                    <input type="text" name="reference_number" class="form-control bg-transparent border-0 @error('reference_number') is-invalid @enderror"
                                           value="{{ old('reference_number') }}" placeholder="Internal Reference ID">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="glass-input-group">
                                    ...
                                    <input type="text" name="other_charges_description" class="form-control bg-transparent border-0 @error('other_charges_description') is-invalid @enderror"
                                           value="{{ old('other_charges_description') }}" placeholder="Logistics, Insurance, etc.">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control rounded-20 bg-light border-0 p-4 @error('description') is-invalid @enderror" 
                                      rows="4" placeholder="Detailed scope of procurement...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-danger small mt-1 fw-600">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <textarea name="terms_conditions" class="form-control rounded-20 bg-light border-0 p-4 @error('terms_conditions') is-invalid @enderror" 
                                          rows="3" placeholder="Legal and operational constraints...">{{ old('terms_conditions') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea name="notes" class="form-control rounded-20 bg-light border-0 p-4 @error('notes') is-invalid @enderror" 
                                          rows="3" placeholder="Restricted audit observations...">{{ old('notes') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-premium rounded-24 overflow-hidden mb-4 sticky-top" style="top: 2rem;">
                    <div class="card-header bg-premium-dark p-4 border-0">
                        <h5 class="mb-0 text-white fw-800">Financial Projection</h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <div class="glass-input-group">
                                ...
                                <input type="number" name="sub_total" id="subTotal" class="form-control bg-transparent border-0 fw-800 text-dark @error('sub_total') is-invalid @enderror"
                                       value="{{ old('sub_total', '0.00') }}" step="0.01" min="0" required>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="glass-input-group">
                                    <input type="number" name="gst_percentage" id="gstPercentage" class="form-control bg-transparent border-0 fw-700 text-dark @error('gst_percentage') is-invalid @enderror"
                                           value="{{ old('gst_percentage', '0') }}" step="0.01" min="0">
                                </div>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="glass-input-group">
                                    <input type="number" name="discount_percentage" id="discountPercentage" class="form-control bg-transparent border-0 fw-700 text-dark @error('discount_percentage') is-invalid @enderror"
                                           value="{{ old('discount_percentage', '0') }}" step="0.01" min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="glass-input-group">
                                ...
                                <input type="number" name="other_charges" id="otherCharges" class="form-control bg-transparent border-0 fw-700 text-dark @error('other_charges') is-invalid @enderror"
                                       value="{{ old('other_charges', '0.00') }}" step="0.01" min="0">
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-light-soft rounded-24 border border-light mb-4 text-center">
                            <span class="text-uppercase small fw-800 text-muted tracking-widest d-block mb-1">Estimated Net Value</span>
                        ...
                        <div class="d-grid gap-3">
                            <button type="submit" class="btn btn-premium-dark shadow-premium py-3 rounded-15 fw-800 text-white">
                                <i class="fas fa-shield-check me-2 text-gold"></i>Authorize Procurement
                            </button>
                            <a href="{{ route('accounts.purchases.orders.index') }}" class="btn btn-light py-3 rounded-15 fw-700 text-muted">
                                Cancel Operation
                            </a>
                        </div>
                    </div>
